<?php
    ...
    $hour = mysqli_query($mysqli, "SELECT date FROM analytic GROUP BY HOUR(date)");
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 card">
                                        <div class="card-header-tab card-header-tab-animation card-header">
                                            ...
                                            <ul class="nav">
                                                <li class="nav-item"><a href="javascript:void(0);" class="active nav-link">A hours</a></li>
...
var data_mid = <?php echo $mid; ?>;
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [<?php while ($b = mysqli_fetch_array($hour)) { echo '"' . date('h', strtotime($b['date'])) . '",';}?>]
        },
        yAxis: {
            min: 0,
            title: {
