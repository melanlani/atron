...
if($_REQUEST['city'] !=''){
    ...
    $sql = "SELECT SUM(up) as count_up FROM analytic WHERE city= '$city' 
...
<div class="app-main__inner">
    ...
    <?php
        ...
        if($_REQUEST['city'] !=''){
            ...
            $query="select regional, city, site_id, site_name, bw, status, current, aging, today_highest, weekly_highest, monthly_highest, yearly_highest from current_occupancy where current<='$value1' and city = '$value' group by current_id";
