<div class="app-main__inner">
    ...
    if($_REQUEST['reg'] !=''){
        ...
        $query="select regional, city, site_id, site_name, bw, status, current, aging, today_highest, weekly_highest, monthly_highest, yearly_highest from current_occupancy where current between '$value1' and '$value2' and regional = '$value' group by current_id";
