<?php
    ...
    $bulan = mysqli_query($mysqli, "SELECT date FROM analytic GROUP BY MONTH(date)");
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3 card">
                                        <div class="card-header-tab card-header-tab-animation card-header">
                                            ...
                                            <ul class="nav">
                                                <li class="nav-item"><a href="grafik_hour.php" class="nav-link">A hours</a></li>
                                                <li class="nav-item"><a href="grafik_day.php" class="nav-link">A day</a></li>
                                                <li class="nav-item"><a href="grafik_week.php" class="nav-link second-tab-toggle">A week</a></li>
                                                <li class="nav-item"><a href="javascript:void(0);" class="active nav-link second-tab-toggle">A month</a></li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
                                            <div class="tab-content">
...
var data_mid = <?php echo $mid; ?>;
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [<?php while ($b = mysqli_fetch_array($bulan)) { echo '"' . date('F', strtotime($b['date'])) . '",';}?>]
        },
        yAxis: {
            min: 0,
            title: {
